...
(function () {
  ...
  const STYLE = `
    ...
    .coop-rail-spacer{ flex:1; min-height:8px; }
    ...
    @media (max-width:640px){
      ...
      .coop-rail-brand, .coop-rail-divider, .coop-rail-section-label, .coop-rail-following, .coop-rail-spacer, .coop-rail-foot, .coop-rail-handle{ display:none; }
  ...
  function build() {
    ...
    rail.innerHTML = `
      ...
      <div class="coop-rail-spacer"></div>
