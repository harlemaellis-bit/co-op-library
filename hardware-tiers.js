...
(function (root) {
  ...
  const CPUS = [
    ...
    ["Intel Core i7 8700K",44.0,4.7],["Intel Core i5 8400",34.0,4.0],
    ["AMD Ryzen 7 2700X",38.0,4.3],["Intel Core i7 7700K",33.0,4.5],
    ["AMD Ryzen 5 2600",33.0,3.9],["Intel Core i5 7600K",27.0,4.2],
    ["Intel Core i7 6700K",30.0,4.2],["AMD Ryzen 7 1700",30.0,3.7],
    ["AMD Ryzen 5 1600",26.0,3.6],["Intel Core i5 6600K",24.0,3.9],
    ["Intel Core i7 4790K",22.0,4.4],["Intel Core i5 4460",14.0,3.4],
    ["AMD FX-8350",12.0,4.2],["Intel Core i3 4160",9.0,3.6],
    // -- Legacy / older (Laptop) --
  ...
  function normalize(s) {
    return s
      .toLowerCase()
      .replace(/\(r\)|\(tm\)|®|™/g, "")
      .replace(/\b(amd|nvidia|intel|geforce|radeon)\b/g, "")
      .replace(/[^a-z0-9]/g, "");
  }
